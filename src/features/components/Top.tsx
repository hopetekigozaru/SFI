...
const Top: React.FC<TopProps> = ({ setIndex }) => {
    ...
    return (
        <section id="mainSection" className='w-full h-full flex justify-end md:items-end animate-fade-in'>
            <div className='w-full md:w-[50%] h-[50%]'>
                <div className='w-full md:w-[85%]'>
                    <p className={`text-white text-4xl md:text-6xl text-center md:text-start tracking-[0.5rem] leading-[3.5rem] md:leading-[5rem] font-zen-maru font-bold`}>
                        人と人を技術<br />でつなぐ。
                    </p>
